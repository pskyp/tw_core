...
class RsaKeyHelper {
  ...
  Future<KeyPair> computeRSAKeyPair(
     ) async {
...
//     dynamic asn1Parser = new ASN1Parser(Uint8List.fromList(publicKeyDER));
//     dynamic topLevelSeq = asn1Parser.nextObject() as ASN1Sequence;
...
//     } else {
//       dynamic publicKeyBitString = topLevelSeq.elements[1];

//       dynamic publicKeyAsn = new ASN1Parser(publicKeyBitString.contentBytes());
...
//     dynamic asn1Parser = new ASN1Parser(Uint8List.fromList(privateKeyDER));
//     dynamic topLevelSeq = asn1Parser.nextObject() as ASN1Sequence;
...
//   String encodePrivateKeyToPemPKCS1(dynamic privateKey) {

//     dynamic topLevel = new ASN1Sequence();

//     dynamic version = ASN1Integer(BigInt.from(0));
//     dynamic modulus = ASN1Integer(privateKey.n);
...
//   String encodePublicKeyToPemPKCS1(dynamic publicKey) {
