...
class _$AllchatsStateTearOff {
  ...
  _AllchatsState call(
      {required Option<List<ChatRoom>> allChatRooms, required ChatType type}) {
...
abstract class $AllchatsStateCopyWith<$Res> {
  ...
  $Res call({Option<List<ChatRoom>> allChatRooms, ChatType type});
}
...
class _$_AllchatsState extends _AllchatsState {
  const _$_AllchatsState({required this.allChatRooms, required this.type})
      : super._();
  ...
  @override
  String toString() {
    return 'AllchatsState(allChatRooms: $allChatRooms, type: $type)';
  }
