...
class CreateJobEvent with _$CreateJobEvent {
  ...
  const factory CreateJobEvent.jobRequirementsChanged(String value) =
      JobRequirementsChanged;
  const factory CreateJobEvent.requiredSubbiesChanged(String value) =
  ...
  const factory CreateJobEvent.onRequirementAdded() = OnRequirementAdded;
