...
/// @nodoc
class _$DevDescriptionFailureTearOff {
  const _$DevDescriptionFailureTearOff();

  TooShort tooShort(dynamic val) {
    return TooShort(
      val,
    );
  }
...
/// @nodoc
const $DevDescriptionFailure = _$DevDescriptionFailureTearOff();

/// @nodoc
mixin _$DevDescriptionFailure {
  ...
  @JsonKey(ignore: true)
  $DevDescriptionFailureCopyWith<DevDescriptionFailure> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DevDescriptionFailureCopyWith<$Res> {
  factory $DevDescriptionFailureCopyWith(DevDescriptionFailure value,
          $Res Function(DevDescriptionFailure) then) =
      _$DevDescriptionFailureCopyWithImpl<$Res>;
  $Res call({dynamic val});
}

/// @nodoc
class _$DevDescriptionFailureCopyWithImpl<$Res>
    implements $DevDescriptionFailureCopyWith<$Res> {
  _$DevDescriptionFailureCopyWithImpl(this._value, this._then);

  final DevDescriptionFailure _value;
  // ignore: unused_field
  final $Res Function(DevDescriptionFailure) _then;
...
class _$TooShortCopyWithImpl<$Res>
    extends _$DevDescriptionFailureCopyWithImpl<$Res>
...
class _$TooShort implements TooShort {
  ...
  @override
  String toString() {
    return 'DevDescriptionFailure.tooShort(val: $val)';
  }
...
abstract class TooShort implements DevDescriptionFailure {
