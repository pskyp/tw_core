...
/// @nodoc
class _$DevTitleFailureTearOff {
  const _$DevTitleFailureTearOff();
...
/// @nodoc
const $DevTitleFailure = _$DevTitleFailureTearOff();

/// @nodoc
mixin _$DevTitleFailure {
  ...
  @JsonKey(ignore: true)
  $DevTitleFailureCopyWith<DevTitleFailure> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DevTitleFailureCopyWith<$Res> {
  factory $DevTitleFailureCopyWith(
          DevTitleFailure value, $Res Function(DevTitleFailure) then) =
      _$DevTitleFailureCopyWithImpl<$Res>;
  $Res call({String val});
}

/// @nodoc
class _$DevTitleFailureCopyWithImpl<$Res>
    implements $DevTitleFailureCopyWith<$Res> {
  _$DevTitleFailureCopyWithImpl(this._value, this._then);

  final DevTitleFailure _value;
  // ignore: unused_field
  final $Res Function(DevTitleFailure) _then;
...
/// @nodoc
class _$TooShortCopyWithImpl<$Res> extends _$DevTitleFailureCopyWithImpl<$Res>
...
class _$TooShort implements TooShort {
  ...
  @override
  String toString() {
    return 'DevTitleFailure.tooShort(val: $val)';
  }
...
abstract class TooShort implements DevTitleFailure {
